...
export const DesktopClientLayout: React.FC<DesktopClientLayoutProps> = ({
  ...
  return (
    <div className={`h-screen w-screen flex flex-col overflow-hidden select-none font-sans ${
      isNoc ? 'bg-black text-white' : 'cyber-bg text-slate-900'
    }`}>
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <main className="flex-1 overflow-y-auto flex flex-col justify-between relative">
          ...
          {/* Floating WhatsApp Support Button (Brand Official) */}
          <a
            href="https://api.whatsapp.com/send?phone=5521997058709&text=Ol%C3%A1,%20preciso%20de%20suporte%20técnico%20com%20o%20AnecttaDESK"
            target="_blank"
            rel="noopener noreferrer"
            className="whatsapp-floating"
            title="Falar com Suporte Técnico Anectta no WhatsApp"
          >
